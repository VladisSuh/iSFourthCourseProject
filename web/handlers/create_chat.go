...
func CreateChat(c *gin.Context) {
	...
	inviteeUsername := strings.TrimSpace(c.PostForm("invitee_username"))
	...
	prime, err := algoprotoc.GeneratePrime(2048)
	if err != nil {
	...
	var newChatID int
	chatName := "Chat with " + inviteeUsername
	...
	// Создаем приглашение в таблице invites
